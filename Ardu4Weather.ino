        ...
        if (c == '\n') { // Check for end of line
          ...
          if (url == "/") {
            ...
            break;
              ...
              client.print(".footer-p { color: #ffffff; text-align: center; margin-bottom: 20px; font-size: 16px; }");
              ...
              client.print("img { max-width: 30%; height: auto; border-radius: 16px; margin: 10px; }");
              ...
              client.print("<div class='image-text-container'>");
              client.print("<div class='image-text-pair'><img src=\'https://i.imgur.com/2Vkg8gU.jpeg' alt=\'Arduino R4 WiFi Image Close'><div class='image-text'>");
              client.print("<p>My Arduino Uno R4 WiFi is the heart of this project, hosting the website you're currently viewing, complete with all subpages. It's connected to a variety of sensors, including a DHT22 for temperature and humidity, a BMP180 for barometric pressure, and a photoresistor for light levels. The Arduino collects data constantly in the loop() function, processing it and sending it to the website in real-time.</p>");
              client.print("</div></div>");
              client.print("<h2>Breadboard</h2>");
              client.print("<div class='image-text-pair'><img src=\'https://i.imgur.com/Z8AHWJq.jpeg' alt=\'Arduino Breadboard Image'><div class='image-text'>");
              client.print("<p>This is the breadboard that contains most of the sensors used in this project. It is a small, clear, standard 30x10 breadboard.</p>");
              client.print("</div></div>");
              client.print("<h2>Arduino Full Image</h2>");
              client.print("<div class='image-text-pair'><img src=\'https://i.imgur.com/yuNZByw.jpeg' alt=\'Arduino Full Image'><div class='image-text'>");
              client.print("<p>This is an image of the full project with breadboard and Arduino in view. You can also see the wires that lead outside my window for the external DHT sensor.</p>");
              client.print("</div></div>");
              client.print("<h2>Microphone Sensor Image</h2>");
              client.print("<div class='image-text-pair'><img src=\'https://i.imgur.com/541JSSP.jpeg' alt=\'Microphone Sensor Image'><div class='image-text'>");
              client.print("<p>Not quite sure how this one works yet but the analog output is connected to analog pin A3</p>");
              client.print("</div></div>");
              client.print("<h2>Pressure Sensor Image</h2>");
              client.print("<div class='image-text-pair'><img src=\'https://i.imgur.com/uKWry8u.jpeg' alt=\'Pressure Sensor Image'><div class='image-text'>");
              client.print("<p>BMP180</p>");
              client.print("</div></div>");
              client.print("<h2>DHT Sensor Image</h2>");
              client.print("<div class='image-text-pair'><img src=\'https://i.imgur.com/A5zKZvm.jpeg' alt=\'DHT Sensor Image'><div class='image-text'>");
              client.print("<p>This is the internal DHT22 sensor, it returns the temperature and humidity digitally.</p>");
              client.print("</div></div>");
              client.print("<h2>Light Sensor Image</h2>");
              client.print("<div class='image-text-pair'><img src=\'https://i.imgur.com/7kgKpvS.jpeg' alt=\'Light Sensor Image'><div class='image-text'>");
